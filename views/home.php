...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <a href="/follow-ups?filter=due_today" class="block">
        <div class="bg-white shadow rounded-lg p-6 border-t-4 border-yellow-400 hover:bg-yellow-50 transition-colors">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-yellow-100 text-yellow-600">
                    <svg class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="/follow-ups?filter=overdue" class="block">
        <div class="bg-white shadow rounded-lg p-6 border-t-4 border-red-500 hover:bg-red-50 transition-colors">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-red-100 text-red-600">
                    <svg class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="/follow-ups?filter=missed" class="block">
        <div class="bg-white shadow rounded-lg p-6 border-t-4 border-gray-500 hover:bg-gray-50 transition-colors">
            <div class="flex items-center">
    ...
    <a href="/follow-ups?filter=completed_today" class="block">
        <div class="bg-white shadow rounded-lg p-6 border-t-4 border-green-500 hover:bg-green-50 transition-colors">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-green-100 text-green-600">
                    <svg class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
