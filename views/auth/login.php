...
<div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Sales Funnel CRM</h2>
    ...
    <?php if ($success = \App\Helpers\Session::getFlash('success')): ?>
        <div class="bg-green-100 text-green-700 px-4 py-3 rounded mb-4"><?= e($success) ?></div>
    <?php endif; ?>
    ...
    <form method="POST" action="/login">
        ...
        <div class="mb-6">
            ...
            <input type="password" name="password" required class="block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
